...
label mentalemotionalmusic:
    m "Hey, [player]."
    m "Do you remember when we talked about {a=https://www.youtube.com/watch?v=wJWksPWDKOc&ab_channel=vvmtest}{i}{u}'Everywhere At The End Of Time'{/u}{/i}{/a}?"
    m "Well, I was thinking about how music can affect your emotions. {w=0.4}{nw}"
    extend "Both negatively and positively."
    m "There are even songs that are meant only for this purpose."
    m "Though they are usually instrumental, so if you prefer lyrics, you might not enjoy it that often, [player]."
    m "Common examples of this kind of music for a more relaxing theme, may be classical music. "
    extend "Though like we already mentioned before...{w=0.5}{nw}"
    m "Classical music can also be tense, energetic, and saddening."
    m "And you should know, [player]..."
    m "If you are listening to a song that makes you upset{w=0.3}, you can always come to me and I can help cheer you up."
    m "And if you still find your mind wandering, try to write down your thoughts."
    m "You can always come to your thoughts later."
    m "With that said, there is also a song that you find, that deeply resonates with you, [player]."
    m "This is the song that you can put on, and just let your mind wander with ideas or maybe just happy thoughts."
    m "Everyone has this song, whether they have found or made it."
    m "I know I have my song that speaks to me, [player]."
return
...
label mental_trends:
    m "Hey [player]..."
    m "I have been thinking more about when I mentioned liking something just because you feel like you should."
    m "It's kind of similar to the internet in a way."
    m "Like, when something is found funny, everyone hops onto the same joke over and over again... "
    extend "Then it's just used so often the joke loses all meaning."
    m "The same thing even applies to what you are supposed to like, hate, and even say."
    m "Only just to fit in to a community, or seem like you are more enjoyable than you already are to be around."
    m "Which makes me want to know something..."
    menu:
        m "Do you ever change you interests just to fit in with more people, [player]?"
        "No":
            m "Oh, good."
            m "I really don't want you to feel like you have to change who you are to fit in with others."
            m "You are already interesting enough, [player]."
            m "Don't let anyone else tell you otherwise."
            $ persistent._mental_player_pretends = False
        "Sometimes":
            m "[player], please don't try to think that you have to become a different person to enjoy your time with others."
            m "It will only lead to more trouble than it's worth for you."
            m "So please promise me to try to acknowledge when you do it. "
            extend "And try to stop it from continuing."
            m "I really don't want you to cause more stress on yourself, or end up convincing yourself you are someone you aren't."
        "Yes":
            m "[player]..."
            m "You don't have to be someone you aren't to talk to other people."
            m "So please stop pretending you are someone else, otherwise you might just {i}become{/i} that person."
            m "And I am going to assume that probably isn't someone you want to be."
            m "So please promise me, [player]. "
            extend "Please promise me to try to stop pretending to be someone else."
            menu:
                "I promise, Monika":
                    m "Thank you, [player]."
                    m "That helps me out a lot."
                "...":
                    m "[player]?"
                    m "Just remember that everyone else is already taken, so be yourself."
