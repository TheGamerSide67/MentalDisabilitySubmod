...
label mentalOCD:
    ...
    m 3euc "That is why it is so difficult to get a proper diagnoses of OCD, not only can it be similar to a {i}tic{/i}, it can also be similar to repeat actions people with other disabilities may do normally."
