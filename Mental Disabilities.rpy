init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="mentalADHD",category=['media'],prompt="ADHD",random=True))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="mentalPTSD",category=['media'],prompt="PTSD",random=True))
...
label mentaldementia:
    ...
    m 1rksdlc "Though it's not exactly the most ideal feeling..."
