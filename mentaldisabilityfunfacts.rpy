init 5 python:
    addEvent(
        Event(
            ...
            eventlabel="mentalhealth_illnesses",
        ),
        code="FFF"
    )
...
init 5 python:
    addEvent(
        Event(
            persistent._mas_fun_facts_database,
            eventlabel="mentalhealth_misdiagnoses_history",
        ),
        code="FFF"
    )

label mentalhealth_misdiagnoses_history:
    ...
    m 1eud "There is a lot of history to autism here... {w=0.3}{nw}"
