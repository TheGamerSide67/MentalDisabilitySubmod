init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="mentalmaskingdisability",category=['media'],prompt="Masking Autism",random=True))
...
label mentalmaskingdisability:
    ...
    if persistent._player_has_autism == True:
        ...
        m 1eud "Just make sure not to push yourself onto them and give them time too,"
